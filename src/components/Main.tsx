...
export default function Basic() {
    ...
    let ButtonHandler4 = () => {
        ...
        useEffect(() => {
            axios.get(`https://api.openweathermap.org/geo/1.0/direct?q=${town}','RUS'&limit=1&appid=724d0a79dd839b898173c769b23492e5`).then(res => {
                setLatid(res.data[0].lat);
                setLongit(res.data[0].lon);
            });

            axios.get(`https://api.openweathermap.org/data/3.0/onecall?lat=${lat}&lon=${lon}&appid=724d0a79dd839b898173c769b23492e5&units=metric`).then(res => {
